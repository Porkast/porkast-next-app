...
const CreatePlaylistDialog = forwardRef<CreatePlaylistDialogRef>((_props, ref: Ref<CreatePlaylistDialogRef>) => {
    ...
    const onSubmitToCreatePlaylistBtnClick = async () => {
        ...
        if (createResp && createResp.code == 0) {
            ...
            appContext.showMsgAlert(createResp?.message || 'Error', MsgAlertType.FAILED)
        }
        setIsLoading(false)
    }
