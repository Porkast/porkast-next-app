...
const AddToPlayListDialog = forwardRef<AddToPlayListDialogRef>((_props, ref: Ref<AddToPlayListDialogRef>) => {
    ...
    const onSubmitToPlaylistBtnClick = async () => {
        ...
        if (resp && resp.code == 0) {
            ...
            appContext.showMsgAlert(resp?.message || 'Error', MsgAlertType.FAILED)
        }
