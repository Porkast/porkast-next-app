...
export default function ShareListenLaterPage() {
    ...
    useEffect(() => {
        ...
        const fetchShareCode = async () => {
            const code = await createRSSShareCode(userRef, 'listenlater', '')
                    ...
                    <div className="w-full flex justify-center min-h-screen">
                        <div className="w-full max-w-2xl">
                            ...
                            <div className="w-full flex justify-center pl-6 pr-6 pt-9">
                                <div className="text-base">{nickname}{`'s Porkast Listen Later`}</div>
                            </div>
                            ...
                            <div className="w-full flex justify-center pl-6 pr-6 mt-3">
                                <Link
                                    to={`/guide/apple-podcast?url=${encodeURIComponent(shareLink ?? rssLink)}&type=listenlater&title=${encodeURIComponent(nickname ? `${nickname}'s Listen Later` : 'Listen Later')}`}
