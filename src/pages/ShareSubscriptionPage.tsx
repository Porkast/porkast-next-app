                    ...
                    <div className="w-full flex justify-center min-h-screen">
                        <div className="w-full max-w-2xl">
                            <div className="w-full flex justify-center">
                                <div className="text-2xl font-bold">#{decodedKeyword} - RSS Source Viewer</div>
                            </div>
                            ...
                            <div className="w-full flex justify-center pl-6 pr-6 mt-3">
                                <Link
                                    to={`/guide/apple-podcast?url=${encodeURIComponent(shareLink ?? rssLink)}&type=subscription&title=${encodeURIComponent(`#${decodedKeyword}`)}`}
