                ...
                <div className='w-full max-w-2xl pt-28 pl-6 pr-6'>
                    ...
                    <div className='w-full'>
                        ...
                        <div className="w-full flex justify-start mt-4">
                            ...
                            <div className="ml-3">
                                <div className="text-sm font-medium text-gray-500 mt-2">By {data.Author}</div>
